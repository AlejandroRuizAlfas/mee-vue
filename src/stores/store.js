...
export const useStore = defineStore('store', {
	...
	actions: {
		...
		async deleteNoteStore(note) {
			let response = await axios.post(url + '/notes/delete', JSON.stringify(note.note_id));
			return response.data;
		},
		...
		async deleteBuylisStore(list) {
			let response = await axios.post(url + '/buylist/delete', JSON.stringify(list.buylist_id));
			return response.data;
		},
		...
		async deleteMapStore(map) {
			let response = await axios.post(url + '/maps/delete', JSON.stringify(map.map_id));
			return response.data;
		},
		...
		async deleteTodoStore(todo) {
			let response = await axios.post(url + '/todos/delete', JSON.stringify(todo.todo_id));
			return response.data;
		},
		stopAxiosLoading() {
			this.isAxiosLoading = false;
	...
	getters: {
		...
		getAllCategories: (state) => async () => {
			let response = await axios.get(url + '/categories/get');
			return response.data;
		},
